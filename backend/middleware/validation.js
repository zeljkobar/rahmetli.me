...
const validateUserRegistration = [
    body('username')
        ...
        .matches(/^[a-zA-Z0-9._-]+$/)
        .withMessage('Korisničko ime može sadržavati samo slova, brojevi, tačke, crtice i podvlake'),
    ...
    body('password')
        ...
        .matches(/^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)/)
        .withMessage('Lozinka mora sadržavati bar jedno malo slovo, veliko slovo i broj'),
